...
This example was generated for architecture armv8Linux4gcc7.3.0, using the
data type PixyCamConfig from ShapeType.idl.
...
> make -f makefile_ShapeType_armv8Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_ShapeType_armv8Linux4gcc7.3.0 DEBUG=1
...
Run /Applications/rti_connext_dds-6.1.1/resource/scripts/rtisetenv_armv8Linux4gcc7.3.0.bash
...
> objs/armv8Linux4gcc7.3.0/ShapeType_publisher -d <domain_id> -s <sample_count>
> objs/armv8Linux4gcc7.3.0/ShapeType_subscriber -d <domain_id> -s <sample_count>
