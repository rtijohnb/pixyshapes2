...
int run_publisher_application(unsigned int domain_id, unsigned int sample_count)
{
    ...
    const char *type_name = PixyCamConfigTypeSupport::get_type_name();
    DDS_ReturnCode_t retcode =
    PixyCamConfigTypeSupport::register_type(participant, type_name);
    ...
    // This DataWriter writes data on "Example PixyCamConfig" Topic
    ...
    PixyCamConfigDataWriter *typed_writer =
    PixyCamConfigDataWriter::narrow(untyped_writer);
    ...
    PixyCamConfig *data = PixyCamConfigTypeSupport::create_data();
    if (data == NULL) {
        return shutdown_participant(
            participant,
            "PixyCamConfigTypeSupport::create_data error",
            EXIT_FAILURE);
    }
    ...
    ++samples_written) {
        ...
        std::cout << "Writing PixyCamConfig, count " << samples_written 
        << std::endl;
    ...
    // Delete previously allocated PixyCamConfig, including all contained elements
    retcode = PixyCamConfigTypeSupport::delete_data(data);
    if (retcode != DDS_RETCODE_OK) {
        std::cerr << "PixyCamConfigTypeSupport::delete_data error " << retcode
        << std::endl;
    }
