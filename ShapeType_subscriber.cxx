...
unsigned int process_data(PixyCamConfigDataReader *typed_reader)
{
    PixyCamConfigSeq data_seq;     // Sequence of received data
...
int run_subscriber_application(unsigned int domain_id, unsigned int sample_count)
{
    ...
    // This DataReader reads data on "Example PixyCamConfig" Topic
    ...
    PixyCamConfigDataReader *typed_reader =
    PixyCamConfigDataReader::narrow(untyped_reader);
